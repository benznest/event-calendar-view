...
import com.benzneststudios.library.eventcalendarstory.adapter.EventListViewAdapter;
import com.benzneststudios.library.eventcalendarstory.model.Event;
 ...
 */
public class ListMyEvent extends FrameLayout {
    ...
    public ListMyEvent(Context context) {
        super(context);
        initInflate();
        initInstance();
    }

    public ListMyEvent(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstance();
    }

    public ListMyEvent(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ListMyEvent(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
