package com.benzneststudios.library.eventcalendarstory.view;
...
public class CustomRowEventCalendar extends FrameLayout {
    ...
    public void setOnClickEventItem(OnClickListener onClickListener) {
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_EVENT_ID, eventId);
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_TITLE, tvTitle.getText().toString());
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_DESCRIPTION, tvDescription.getText().toString());
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_DAY, tvDayOfMonth.getText().toString());
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_DAY_OF_WEEK, tvDayOfWeek.getText().toString());
        linearLayoutRowEvent.setTag(ListMyEvent.KEY_TIME, tvTime.getText().toString());
