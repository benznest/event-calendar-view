...
import com.benzneststudios.library.eventcalendarstory.MyConstant;
...
import com.benzneststudios.library.eventcalendarstory.Util.MyUtils;
import com.benzneststudios.library.eventcalendarstory.adapter.CalendarDateAdapter;
import com.benzneststudios.library.eventcalendarstory.model.DayCalendar;
...
public class CalendarFragment extends Fragment {
    ...
    private static int textDayColor = ListMyEvent.NOT_CUSTOM_COLOR;
    private static int textMonthColor = ListMyEvent.NOT_CUSTOM_COLOR;
    private static int backgroundCalendarColor = ListMyEvent.NOT_CUSTOM_COLOR;
    private static int backgroundHeaderDay = ListMyEvent.NOT_CUSTOM_COLOR;
    private static int backgroundHeaderMonth = ListMyEvent.NOT_CUSTOM_COLOR;

    public static int circleColorToday = ListMyEvent.NOT_CUSTOM_COLOR;
    ...
    private void intInstance(View rootView) {
        ...
        for (int i = 0; i < dayInCalendar.size(); i++) {
            ...
            if (calendarMonth != null) {
                day.setMonth("" + calendarMonth.getMonth());
                day.setYear("" + calendarMonth.getYear());
            }
    ...
    private void setAdapterCalendar(CalendarDateAdapter adapter) {
        ...
        for (TextView tv : tvDay) {
            setTextViewColor(tv, textDayColor);
        }
    ...
    public static void setTextDayColor(int res_color) {
        if (res_color != ListMyEvent.NOT_CUSTOM_COLOR) {
